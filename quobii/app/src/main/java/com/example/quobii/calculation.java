...
//                        Toast.makeText(calculation.this, "Please enter the base to be calculated", Toast.LENGTH_SHORT).show();
//
//                    } else {
                    ...
                    String formattedResult = format("%.2f", result);
                    et3.setText(formattedResult);

//                    }

                } catch (NumberFormatException e) {
                    Toast.makeText(calculation.this, "numeric error", Toast.LENGTH_SHORT).show();
