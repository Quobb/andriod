...
public class MainActivity extends AppCompatActivity {
         ...
         EditText txtbases,txtheights,txthypos;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        txtbases.findViewById(R.id.txtbase);
        txtheights.findViewById(R.id.txtheight);
        txthypos.findViewById(R.id.txthypo);
    }
        ...
        Button btncalculate = findViewById(R.id.btnCal); // Replace 'btnCalculate' with the actual ID of your button.
         try {
             ...
             if(strBase.isEmpty() &&  strHeight.isEmpty()){
                 Toast.makeText(this, "Please enter the height and base to be calculated", Toast.LENGTH_SHORT).show();
                 return;
             }
